...
def main():
    ...
    if args.task == "MNLI":
        ...
        def name_from_datapath(datapath):
            return datapath.split("QNLI")[-1].strip(".tsv").strip("/").replace("_", "-")
        ...
        def name_from_datapath(datapath):
            return datapath.split("SST-2")[-1].strip(".tsv").strip("/").replace("_", "-")
        ...
        def name_from_datapath(datapath):
            return datapath.split("CoLA")[-1].strip(".tsv").strip("/").replace("_", "-")
        ...
        def name_from_datapath(datapath):
            return datapath.split("STS-B")[-1].strip(".tsv").strip("/").replace("_", "-")
        ...
        def name_from_datapath(datapath):
            return datapath.split("MRPC")[-1].strip(".tsv").strip("/").replace("_", "-")
        ...
        def name_from_datapath(datapath):
            return datapath.split("RTE")[-1].strip(".tsv").strip("/").replace("_", "-")
