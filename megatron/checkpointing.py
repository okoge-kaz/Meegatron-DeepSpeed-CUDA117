...
from megatron import get_args, is_rank_0, mpu, print_rank_0, update_num_microbatches, utils
...
def load_checkpoint(
    model, optimizer, lr_scheduler, load_arg="load", strict=True, load_only_weights=False
):
    ...
    if args.deepspeed:
        ...
        if loaded_dir is None:
            print_rank_0("WARNING: could not find the metadata file {} ".format(load_dir))
